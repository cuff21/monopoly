// Trade flow, mixed onto Game.prototype. Private state below is module-scoped closure state
...
(function() {
	...
	// Called once by the Game() constructor once the trade panel's DOM elements exist.
	Game.prototype._initTradeInputHandlers = function() {
	...
	Game.prototype.trade = function(tradeObj) {
	...
	Game.prototype.acceptTrade = function(tradeObj) {
	...
	Game.prototype.proposeTrade = function(skipConfirmation) {
		if (isNaN(document.getElementById("trade-leftp-money").value)) {
			document.getElementById("trade-leftp-money").value = "This value must be a number.";
			document.getElementById("trade-leftp-money").style.color = "red";
			return false;
